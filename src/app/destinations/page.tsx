...
import { MapPin, Star, Search, ArrowRight, Compass, Loader2 } from "lucide-react";
...
export default function DestinationsPage() {
    ...
    useEffect(() => {
        getDestinations().then((data) => {
            setAllDestinations(data as Destination[]);
            setLoading(false);
        });
    }, []);
                ...
                <section className="bg-slate-900 py-24 px-6 text-center relative overflow-hidden">
                    ...
                    >
                        ...
                        <p className="text-slate-400 text-lg font-medium max-w-xl mx-auto mb-10">
                            Browse all {loading ? "..." : allDestinations.length} curated destinations across Côte d&apos;Ivoire. Filter by category or search by name.
                        </p>
